          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: _buildWhatsAppNumber(controller.whatsapp.value),
              ),
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildSocialMediaItem(SvgPicture.asset(AppSvg.facebook), "Facebook", controller.facebook.value),
                      const SizedBox(height: 15),
                      _buildSocialMediaItem(SvgPicture.asset(AppSvg.instagram), "Instagram", controller.instagram.value),
                      const SizedBox(height: 15),
                      _buildSocialMediaItem(SvgPicture.asset(AppSvg.tiktok), "TikTok", controller.tiktok.value),
                    ],
                  ),
                ),
              ),
